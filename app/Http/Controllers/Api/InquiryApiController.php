...
class InquiryApiController extends ApiBaseController
{
    ...
    public function test()
    {
        ...
        $data = file_get_contents("https://dev.virtualearth.net/REST/v1/Routes/DistanceMatrix?origins=$from&destinations=$to&travelMode=driving&key=AoQ1_RhiXbz8RQ36RbFTnPkRLu6yNFAfLaKKp-_kK6mrk_fm0yEA3pd-bEltlGl1");
